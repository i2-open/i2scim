...
public class CycleTestKeys {
    ...
    static final String PUB_KEY = "./i2scim-server/src/test/resources/certs/jwks-certs.json";
    static final String PRIV_KEY = "./i2scim-server/src/test/resources/data/jwk-sign.json";
    ...
    public static void initKeyPair(String pubKeyPath, String privKeyPath) {
        try {
            ...
            File parent = pubFile.getParentFile();
