...
public class TestUtils {
    ...
    /**
     * Enables Quarkus MongoDB Dev Services (pinned to mongo:8.2) for the calling test profile.
     ...
     * The image is pinned to mongo:8.2 to match the Testcontainers-based signals tests, so a full
    ...
    public static void enableMongoDevServices(Map<String,String> map) {
        ...
        map.put("quarkus.mongodb.devservices.image-name","mongo:8.2");
    }
