...
/**
 * Regression tests for issue #99: filtering on externalId must work on the Mongo provider regardless of filter
 * casing or the casing of the externalId attribute in a previously persisted common schema.
 */
@QuarkusTest
@TestProfile(ScimMongoTestProfile.class)
@TestMethodOrder(MethodOrderer.MethodName.class)
public class MongoExternalIdFilterTest {

    static final Logger logger = LoggerFactory.getLogger(MongoExternalIdFilterTest.class);
    ...
    static final String EXT_ID = "ext-99-bjensen";
    ...
    public void a_init() throws Exception {
        logger.info("========== Mongo externalId Filter Test ==========");
     ...
     * Mongo filter mapping must still query the canonical stored field "externalId".
     */
    @Test
