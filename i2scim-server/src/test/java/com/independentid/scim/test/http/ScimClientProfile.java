...
public class ScimClientProfile implements QuarkusTestProfile {
    @Override
    public Map<String, String> getConfigOverrides() {
        Map<String, String> cmap = new HashMap<>(Map.of(
                "scim.schema.path","/schema/scimSchema.json",  //this test schema changes some default returns for testing
                "scim.resourcetype.path","/schema/resourceTypes.json",
