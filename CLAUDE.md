...
Java 25 / Quarkus 3.39.5 / Jakarta EE 11. Group: `com.independentid`, version: `0.10.3`. Build with the Maven wrapper (`./mvnw`, Maven 3.9.16) — Quarkus 3.39 requires Maven ≥ 3.9.6; plain `mvn` below assumes a new-enough system Maven.
