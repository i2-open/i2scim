...
public class ScimResourceTest {
	...
	private Logger logger = LoggerFactory.getLogger(ScimResourceTest.class);
	...
	private String entSchema = "urn:ietf:params:scim:schemas:extension:enterprise:2.0:User";
	...
	public void a_ScimResParseUser1Test() {
		...
		try {
			...
			userStream = resourceloader.getResource(testUserFile2).getInputStream();
