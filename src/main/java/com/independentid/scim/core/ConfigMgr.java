...
public class ConfigMgr {
	...
	private static LinkedHashMap<String,Schema> schIdMap = new LinkedHashMap<>();
	private static LinkedHashMap<String,Schema> schNameMap = new LinkedHashMap<>();
	
	//private TreeMap<String,Attribute> vals = new TreeMap<String,Attribute>();
	
	private static  LinkedHashMap<String,ResourceType> rTypes = new LinkedHashMap<>();
	private static  HashMap<String,ResourceType> rTypePaths = new HashMap<>();
	...
	public synchronized void initializeConfiguration() throws ScimException,IOException {
		...
		if (configOnly || !this.persistSchemaMode()) {
			loadDefaultSchema();
	...
	public FileInputStream getClassLoaderFile(final String file) throws IOException {
	 ...
	 */
	public File findClassLoaderResource(final String file) throws IOException {
	...
	public synchronized void shutdown() {
		...
		System.out.println("ConfigMgr shutdown.");
		rTypePaths.clear();
		rTypePaths = null;
		rTypes.clear();
		rTypes = null;
