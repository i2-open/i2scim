...
public class OpStat {
    ...
    /**
     * The request number since server startup. The number is assigned based on the order it was received
     */
    protected int requestNum;

    /**
     * The execution number since server startup. Used to compare actual order of events in a server
     */
    ...
    /**
     * Used to track statistics and reporting of a normal operation. For bulk operations it tracks request and execution
     * numbers.
     * @param bulkRequestNum The request number (operation number) from a bulk request.
     */
    ...
    public Date getStartDate() {
        return Date.from(this.receiveDate);
    }

    public Date getFinishDate() {
        return Date.from(this.finishDate);
    }
