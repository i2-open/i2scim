...
public class Schema implements ScimSerializer {
    ...
    /**
     * Create a new {@link Schema} object based on Json Parser
     * @param schemaManager The current Scim {@link SchemaManager} instance
     * @param node          A {@link JsonNode} parser handle containing a SCIM Schema object
    ...
    /**
     * @return A String containing the identifier for the schema. Typically this is a urn. For example
    ...
    /**
     * @param id A String containing the schema identifier for the schema being defined. For example
     *           urn:ietf:params:scim:schemas:core:2.0:ServiceProviderConfig:
     */
    ...
    /**
     * @return Returns a SCIM Meta object containing SCIM meta information entry (e.g. location, resourceType, created,
     * modified, version).
     */
    public Meta getMeta() {
        return this.meta;
    ...
    /**
     * @param meta Sets the SCIM Meta information using a Meta object containing SCIM meta information entry (e.g.
     *             location, resourceType, created, modified, version).
     */
    ...
    /**
     * @return A String containing the name of the schema type (e.g. User). Often corresponds to the "id" of the
     * resource type.
     */
    ...
    /**
     * @param name A String containing the name of the schema type (e.g. User). Often corresponds to the "id" of the
     *             resource type.
     */
