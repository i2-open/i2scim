...
public class KafkaRepEventHandler implements IEventHandler {
    ...
    public void init() {
        ...
        //Transactional id is always client_id.
        prodProps.put(ProducerConfig.TRANSACTIONAL_ID_CONFIG,clientId);
    ...
    private void initId() {
        ...
        if (kafkaState.exists() ) {
            ...
            try {
                clientIdProp.store(new FileWriter(kafkaState),"i2Scim Replication Kafka client data");
